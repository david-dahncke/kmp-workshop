...
class FakeItemRepository(
    ...
    companion object {
        fun defaultItems() = listOf(
            Item("item-001", "Kotlin Handbook", "Kurz", 29.99, "https://example.com/1.jpg", "Lang", "SKU-KH-001"),
            Item("item-002", "KMP Guide", "Kurz", 19.99, "https://example.com/2.jpg", "Lang", "SKU-KMP-002"),
            Item("item-003", "Clean Architecture", "Kurz", 24.99, "https://example.com/3.jpg", "Lang", "SKU-CA-003"),
        )
    }
}
