...
| `02-repository` | + Ktor MockEngine, Repository | **Bug 7.1** |
| `03-state` | + Use Cases, ScreenState, vollständige UI | **Bug 7.1** |
| `04-platform` | + expect/actual, Logger, Koin, SQLDelight | **Bug 7.1 + 7.2** |
| `05-tests` | + Tests, Bugs gefixt — **Referenzlösung** | — |
| `06-favorit-uebung` | Auf `05-tests` aufgebaut, Favoriten-Feature unvollständig | — |
